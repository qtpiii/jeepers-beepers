...
public class TagRegistry {
    public static class Blocks {
        ...
        public static final TagKey<Block> SEED_CROPS = createTag("seed_crops", true, 3);
        ...
        public static final TagKey<Block> SINGLE_YIELD_CROPS = createTag("single_yield_crops", true, 3);
        public static final TagKey<Block> FRUIT_CROPS = createTag("fruit_crops", true, BlockRegistry.DRAGONFRUIT_TREE, 6);
