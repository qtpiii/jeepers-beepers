...
public class TagRegistry {
    public static class Blocks {
        ...
        public static final TagKey<Block> SEEDLESS_CROPS = createTag("seedless_crops", true, 8);
        ...
        public static final TagKey<Block> VEGETABLE_CROPS = createTag("vegetable_crops", true, 4);
