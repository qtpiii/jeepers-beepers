...
public class BiomeRegistry {
    public static final ResourceKey<Biome> BIRCH_MIGNONETTE_FOREST = ResourceKey.create(Registries.BIOME,
            new ResourceLocation(JeepersBeepers.MOD_ID, "birch_mignonette_forest"));
    ...
    public static Biome birchMignonetteForest(BootstapContext<Biome> context) {
