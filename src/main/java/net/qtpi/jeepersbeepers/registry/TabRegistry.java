    ...
    public static final CreativeModeTab JEEPERSBEEPERS_TAB = Registry.register(BuiltInRegistries.CREATIVE_MODE_TAB, new ResourceLocation(JeepersBeepers.MOD_ID, "jeepersbeepers"),
            FabricItemGroup.builder().title(Component.translatable("itemtab.jeepersbeepers"))
                    .icon(() -> new ItemStack(ItemRegistry.SPICY_HONEY_BOTTLE)).displayItems((displayContext, entries) -> {
                        ...
                        entries.accept(BlockRegistry.PETRIFIED_MIGNONETTE_LOG);
                        entries.accept(BlockRegistry.PETRIFIED_MIGNONETTE_WOOD);
                        entries.accept(BlockRegistry.STRIPPED_PETRIFIED_MIGNONETTE_LOG);
                        entries.accept(BlockRegistry.STRIPPED_PETRIFIED_MIGNONETTE_WOOD);
                        entries.accept(BlockRegistry.PETRIFIED_MIGNONETTE_PLANKS);
                        entries.accept(BlockRegistry.PETRIFIED_MIGNONETTE_STAIRS);
                        entries.accept(BlockRegistry.PETRIFIED_MIGNONETTE_SLAB);
                        entries.accept(BlockRegistry.PETRIFIED_MIGNONETTE_BUTTON);
                        entries.accept(BlockRegistry.PETRIFIED_MIGNONETTE_PRESSURE_PLATE);
                        entries.accept(BlockRegistry.PETRIFIED_MIGNONETTE_FENCE);
                        entries.accept(BlockRegistry.PETRIFIED_MIGNONETTE_FENCE_GATE);
                        entries.accept(BlockRegistry.PETRIFIED_MIGNONETTE_DOOR);
                        entries.accept(BlockRegistry.PETRIFIED_MIGNONETTE_TRAPDOOR);
