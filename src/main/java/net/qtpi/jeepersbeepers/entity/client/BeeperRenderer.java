...
public class BeeperRenderer extends GeoEntityRenderer<BeeperEntity> {
    ...
    @Override
    public void preRender(PoseStack poseStack, BeeperEntity animatable, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
        if (!isReRender) {
